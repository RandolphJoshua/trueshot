...
INSERT INTO `product_data` (`id`, `sku`, `brand`, `modelName`, `conditionGrade`, `description`, `imageUrl`, `lensMount`, `sensorType`, `releaseYear`, `shutterCount`, `stockQuantity`, `price`, `featured`, `available`, `lastUpdated`, `createdAt`) VALUES
  ...
  (6,'TS-006','Canon','RF 24-70mm f/2.8L IS USM','LIKE NEW','Pro standard zoom with pristine optics, original hood, and pouch included.','https://cdn.trueshot.test/images/products/rf-24-70-28.jpg','Canon RF','Full Frame',2019,NULL,6,2099.00,1,1,'2025-01-14 16:12:00','2025-01-07 09:55:00'),
  ...
  (9,'TS-009','Nikon','NIKKOR Z 24-120mm f/4 S','LIKE NEW','Versatile travel zoom, glass freshly cleaned and firmware updated.','https://cdn.trueshot.test/images/products/nikon-24-120-z.jpg','Nikon Z','Full Frame',2021,NULL,5,1096.95,0,1,'2025-01-11 17:05:00','2024-12-29 16:30:00'),
  ...
  (14,'TS-014','DJI','Ronin RS 3 Pro Combo','LIKE NEW','Carbon fiber gimbal kit with focus motor, RavenEye, and counterweight set.','https://cdn.trueshot.test/images/products/dji-rs3-pro.jpg','Universal','N/A',2022,NULL,6,869.00,0,1,'2025-01-06 19:42:00','2024-12-24 09:05:00'),
  ...
  (17,'TS-017','Peak Design','Travel Tripod Carbon Fiber','LIKE NEW','Full carbon kit with phone mount and tool tucked in center column.','https://cdn.trueshot.test/images/products/pd-travel-tripod.jpg','Universal','N/A',2020,NULL,10,599.95,0,1,'2025-01-02 15:10:00','2024-12-16 13:30:00'),
  (18,'TS-018','SmallRig','Modular Camera Cage Kit','NEW','Expandable cage system pre-configured for mirrorless rigs with NATO rails.','https://cdn.trueshot.test/images/products/smallrig-cage.jpg','Universal','N/A',2023,NULL,15,229.00,0,1,'2025-01-01 10:25:00','2024-12-14 09:45:00'),
  (19,'TS-019','SanDisk','Extreme Pro SDXC 512GB V90','NEW','High-speed card tested for sustained 260MB/s write for 6K capture.','https://cdn.trueshot.test/images/products/sandisk-512-v90.jpg','Universal','N/A',2023,NULL,25,299.99,0,1,'2025-01-05 08:05:00','2024-12-21 07:55:00'),
  (20,'TS-020','Angelbird','AV PRO CFexpress 1TB Type B','NEW','Firmware-updated media with 1785 MB/s sustained read and heat sink.','https://cdn.trueshot.test/images/products/angelbird-1tb.jpg','Universal','N/A',2024,NULL,18,549.99,0,1,'2025-01-06 11:11:00','2024-12-23 12:35:00'),
  ...
  (22,'TS-022','Canon','RF 85mm f/1.2L USM DS','LIKE NEW','Dreamy portrait lens with DS coating, minimal use, includes drop-in ND.','https://cdn.trueshot.test/images/products/rf-85-ds.jpg','Canon RF','Full Frame',2020,NULL,4,2999.00,0,1,'2025-01-12 10:55:00','2025-01-03 16:45:00'),
